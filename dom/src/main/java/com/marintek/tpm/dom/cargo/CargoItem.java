...
//import oasisNamesSpecificationUblSchemaXsdCommonAggregateComponents2.GoodsItemType;
...
public class CargoItem implements Comparable<CargoItem> {
  ...
  //  private GoodsItemType goodsItem;
    ...
    public CargoItem(){
        // Initialize goodsItem, either using an xml String or 'from scratch' as here.
//         goodsItem = GoodsItemType.Factory.newInstance();
//         goodsItem.addNewDescription();
//         goodsItem.addNewID(); // equal description??
//         goodsItem.addNewValueAmount();
    }
    
    
    /**
     * Used internally by TransportDemand to fill in pickup and delivery information
     * @return
     */
//    @Programmatic
...
//    }
    ...
    public static enum Unit {
        ...
        Pieces, Pallets, ton, kg, l, Container;
    }
    // {{ Description
...
//        goodsItem.getDescriptionArray(0).setStringValue(description);
    }
    // }}
    // {{ Category
    ...
    public void setHazCode(final CargoItem.HazCode hazcode) {
        ...
        //goodsItem.getHazardousRiskIndicator().setStringValue(hazcode.toString());
    }
    // }}
